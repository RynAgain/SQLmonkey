(function() {
    ...
    function createOverlay() {
        ...
        if (searchInput) {
            searchInput.addEventListener('input', function() {
                ...
                var entries = contentContainer.getElementsByClassName('syntax-entry');
    ...
    function toggleOverlay() {
        ...
        // If overlay is shown, auto-focus the search input for better usability
    ...
    // Expose toggleOverlay to the global scope for external access
